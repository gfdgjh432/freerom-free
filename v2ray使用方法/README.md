...
![1双击运行](https://github.com/gfdgjh432/freerom-free/v2ray使用方法/img/1.png)



双击打开v2rayN，可以看到如下程序主界面。

![2主界面](https://github.com/gfdgjh432/freerom-free/v2ray使用方法/img/2.png)

双击后可能没反应，别着急，在右下角状态栏找到v2ray图标，就是这个蓝底V字图标，左键单击图标，软件界面就出来了。

![3任务栏](https://github.com/gfdgjh432/freerom-free/v2ray使用方法/img/3.png)
...
![4导入节点](https://github.com/gfdgjh432/freerom-free/v2ray使用方法/img/4.png)
...
![5设为活动服务器](https://github.com/gfdgjh432/freerom-free/v2ray使用方法/img/5.png)
...
![6开启代理](https://github.com/gfdgjh432/freerom-free/v2ray使用方法/img/6.png)
